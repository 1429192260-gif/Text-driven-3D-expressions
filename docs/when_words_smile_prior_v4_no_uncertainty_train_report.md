...
- Output: `outputs/when_words_smile_prior_v4/test_uncertainty_prior_fusion_no_uncertainty.pt`
- Checkpoint: `outputs/when_words_smile_prior_v4/uncertainty_prior_fusion_v4_no_uncertainty.pt`
